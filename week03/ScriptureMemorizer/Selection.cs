...
{
    private Dictionary<string, List<(Reference reference, string scripture)>> _scriptureData;

    public Selection()
    {
        _scriptureData = new Dictionary<string, List<(Reference, string)>>
        {
            { "The Book of Mormon", new List<(Reference, string)>
                {
                    ...
                    (new Reference("Alma", 32, 21), "And now as I said concerning faith—faith is not to have a perfect knowledge of things; therefore if ye have faith ye hope for things which are not seen, which are true."),
            ...
            { "The Doctrine and Covenants", new List<(Reference, string)>
                {
                    (new Reference("Doctrine and Covenants", 1, 37), "Search these commandments, for they are true and faithful, and the prophecies and promises which are in them shall all be fulfilled."),
                    (new Reference("Doctrine and Covenants", 8, 2), "Yea, behold, I will tell you in your mind and in your heart, by the Holy Ghost, which shall come upon you and which shall dwell in your heart."),
                    (new Reference("Doctrine and Covenants", 18, 10), "Remember the worth of souls is great in the sight of God."),
                    (new Reference("Doctrine and Covenants", 19, 23), "Learn of me, and listen to my words; walk in the meekness of my Spirit, and you shall have peace in me."),
                    (new Reference("Doctrine and Covenants", 58, 42), "Behold, he who has repented of his sins, the same is forgiven, and I, the Lord, remember them no more.")
                }
            },
            { "The Old Testament", new List<(Reference, string)>
                {
                    (new Reference("Genesis", 1, 1), "In the beginning, God created the heavens and the earth."),
                    (new Reference("Exodus", 20, 3), "Thou shalt have no other gods before me."),
                    ...
                    (new Reference("Psalms", 23, 1), "The Lord is my shepherd; I shall not want.")
                }
            },
            { "The New Testament", new List<(Reference, string)>
                {
                    ...
                    (new Reference("1 Corinthians", 13, 4), "Charity suffereth long, and is kind; charity envieth not; charity vaunteth not itself, is not puffed up.")
                }
            }
        };
    }

    public Dictionary<string, List<(Reference reference, string scripture)>> GetScriptureData()
    {
